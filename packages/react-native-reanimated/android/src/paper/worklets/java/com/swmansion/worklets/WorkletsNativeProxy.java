...
public class WorkletsNativeProxy extends WorkletsNativeProxyCommon {
  ...
  public WorkletsNativeProxy(ReactApplicationContext context, String valueUnpackerCode) {
    super(context);
  ...
  //     LayoutAnimations layoutAnimations) {
  //   WeakReference<LayoutAnimations> weakLayoutAnimations =
  //       new WeakReference<>(layoutAnimations);
  ...
  //             preparedValues.put(key,
  //             simplifyStringNumbersList(stringValue));
  //           } else {
